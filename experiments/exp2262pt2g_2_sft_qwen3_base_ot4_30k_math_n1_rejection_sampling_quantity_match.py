...
"""
Fine-tunes Qwen/Qwen3-8B-Base on 30K OpenThoughts4 math samples with
...
exp2262pt2g_2_qwen3_base_ot4_30k_math_n1_rejsamp = default_sft(
    name="exp2262pt2g_2_qwen3_base_ot4_30k_math_n1_rejsamp_qwen3_32b_32768tokens",
...
exp2262pt2g_2_checkpoint = exp2262pt2g_2_qwen3_base_ot4_30k_math_n1_rejsamp.cd(f"hf/step-{NUM_TRAIN_STEPS - 1}").nonblocking()

if __name__ == "__main__":
    executor_main(steps=[exp2262pt2g_2_qwen3_base_ot4_30k_math_n1_rejsamp])
