...
"""
Fine-tunes meta-llama/Llama-3.1-8B-Instruct on 30K OpenThoughts4 math samples with
annotations generated by Qwen3-32B and filtered by rejection sampling (quantity match):
- marin-community/open-thoughts-4-30k-math-qwen3-32b-annotated-32768-tokens-n1-rejection-sampling-quantity-match
...
DATASET_NAME = "marin-community/open-thoughts-4-30k-math-qwen3-32b-annotated-32768-tokens-n1-rejection-sampling-quantity-match"
...
def create_tokenization_step(dataset_identifier: str, short_name: str) -> ExecutorStep:
    ...
    return default_tokenize(
        name=f"{short_name.split('/')[-1]}_llama_3_1_8b_instruct_tokenizer",
...
llama_3_1_8b_instruct_32768_seq_len = dataclasses.replace(
    llama_3_1_8b_instruct,
    max_seq_len=32768,
    rope=Llama3RotaryEmbeddingsConfig(theta=1_000_000.0),
    cross_entropy_block_size=256,  # Fused cross-entropy: process vocab in 256-token blocks to fit in v5e's 16GB HBM per chip
)

exp2262pt2g_3_llama3pt1_ot4_30k_math_n1_rejsamp = default_sft(
    name="exp2262pt2g_3_llama3pt1_ot4_30k_math_n1_rejsamp_qwen3_32b_32768tokens",
    tokenized=mixture_config,
    model_config=llama_3_1_8b_instruct_32768_seq_len,
    sft_config=mixture_sft_config,
    tags=["llama", "openthoughts4", "sft"],
)

exp2262pt2g_3_checkpoint = exp2262pt2g_3_llama3pt1_ot4_30k_math_n1_rejsamp.cd(f"hf/step-{NUM_TRAIN_STEPS - 1}").nonblocking()

if __name__ == "__main__":
    executor_main(steps=[exp2262pt2g_3_llama3pt1_ot4_30k_math_n1_rejsamp])
