...
"""
Fine-tunes Qwen/Qwen2.5-7B-Instruct on 30K OpenThoughts4 math samples with
...
exp2262pt2g_sft_qwen2pt5_ot4_30k_math_n1_rejsamp = default_sft(
    name="exp2262pt2g_sft_qwen2pt5_ot4_30k_math_n1_rejsamp_qwen3_32b_32768tokens",
    tokenized=mixture_config,
    model_config=qwen2_5_7b_instruct_32768_seq_len,
    sft_config=mixture_sft_config,
    tags=["qwen", "openthoughts4", "sft"],
)

exp2262pt2g_checkpoint = exp2262pt2g_sft_qwen2pt5_ot4_30k_math_n1_rejsamp.cd(f"hf/step-{NUM_TRAIN_STEPS - 1}").nonblocking()

if __name__ == "__main__":
    executor_main(steps=[exp2262pt2g_sft_qwen2pt5_ot4_30k_math_n1_rejsamp])
