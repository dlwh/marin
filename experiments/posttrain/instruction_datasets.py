...
INSTRUCTION_DATASET_NAME_TO_CONFIG = {
    ...
    "marin-community/open-thoughts-4-3745-math-qwen3-32b-annotated-32768-tokens-n8-reformatted": InstructionDatasetConfig(
        hf_dataset_id="marin-community/open-thoughts-4-3745-math-qwen3-32b-annotated-32768-tokens-n8-reformatted",
        revision="e8d3f4e",
        adapter=instruction_response_adapter(
            instruction_column="instruction_seed",
            response_column="generated_text",
        ...
        name="marin-community/open-thoughts-4-3745-math-qwen3-32b-annotated-32768-tokens-n8-reformatted",
        max_parallelism=32,
    ),
