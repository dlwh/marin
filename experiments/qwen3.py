...
qwen3_1pt7b_base_tokenizer = "Qwen/Qwen3-1.7B-Base"
qwen3_1pt7b_base = Qwen3Config(
    # Matching defaults in https://huggingface.co/Qwen/Qwen3-1.7B-Base/blob/main/config.json
    max_seq_len=32768,
    hidden_dim=2048,
    ...
    tie_word_embeddings=True,
    reference_checkpoint="Qwen/Qwen3-1.7B-Base",
